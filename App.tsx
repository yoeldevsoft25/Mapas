...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen w-screen bg-slate-950 overflow-hidden font-sans selection:bg-red-500/30 text-slate-200">
      <Sidebar 
      ...
      <main className="flex-1 relative flex flex-col">
        <header className="h-14 bg-slate-900/50 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-6 z-20">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
              <span className="text-[10px] font-mono text-red-500 font-bold uppercase tracking-[0.2em]">Live Intelligence Feed</span>
            </div>
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="h-8 w-8 rounded-xl bg-slate-800 border border-slate-700 flex items-center justify-center shadow-lg shadow-black/50 cursor-pointer hover:bg-slate-700 transition-colors" onClick={() => setIsMissionModalOpen(true)}>
        ...
        <footer className="h-8 bg-slate-950 border-t border-slate-800 flex items-center px-6 text-[9px] text-slate-600 font-mono overflow-hidden">
